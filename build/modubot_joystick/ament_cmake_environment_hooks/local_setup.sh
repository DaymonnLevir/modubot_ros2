...
: ${AMENT_CURRENT_PREFIX:="/workspace/install/modubot_joystick"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/modubot_joystick/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/modubot_joystick/environment/path.sh"
